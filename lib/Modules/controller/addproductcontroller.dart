...
//             // icon: Icons.check,bgColor: Colors.green
//         );
//       })
//           .onError((error, stackTrace) {
//         handleApiError(error, stackTrace, setError: setError, setRxRequestStatus: setRxRequestStatus);
...
//       required Function(Status) setRxRequestStatus,
//     }) {
...
//     CommonMethods.showToast("No Internet Connection!");
//   } else if (error.toString().contains("TimeoutException")) {
//     CommonMethods.showToast("Connection Timeout! Please try again.");
//   } else if (error.toString().contains("401")) {
//     CommonMethods.showToast("Unauthorized request!");
//   } else {
//     CommonMethods.showToast("Something went wrong. Please try again.");
//   }
// }